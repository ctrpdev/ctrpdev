...
export default function Home() {
  ...
  return (
    <main className="bg-cyan-700 w-screen h-screen grid justify-center items-center 
    p-14
    ">
      <div className="lg:grid lg:grid-cols-2 2xl:p-24 slide-down">
        ...
        <section className="text-gray-100 text-center grid gap-2 md:gap-5
          ...
          ">
          <p className="lg:text-lg xl:text-xl 2xl:text-4xl select-none">{t("hello")} <span className={`${prostoOne.className}`}>ctrp<span className="text-ctrpdev">dev</span></span></p>
